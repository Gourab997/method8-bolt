...
// node_modules/survey-creator-react/fesm/survey-creator-react.mjs
...
var SurveyQuestionCommentValueItem = class extends SurveyQuestionCommentItem {
  ...
  getKey() {
    return this.props.item.normalizedId;
  }
};
...
var SurveyQuestion = class _SurveyQuestion extends SurveyElementBase {
  ...
  renderQuestionContent() {
    ...
    return React.createElement(
      "div",
      { className: question.cssContent || void 0, style: contentStyle, "aria-hidden": question.contentAriaHidden, role: "presentation" },
      questionRender,
      comment,
...
var RatingItemStar = class extends RatingItemBase {
  render() {
    return React.createElement(
      "label",
      { onMouseDown: this.handleOnMouseDown, className: this.question.getItemClass(this.item.itemValue), onMouseOver: (e) => this.question.onItemMouseIn(this.item), onMouseOut: (e) => this.question.onItemMouseOut(this.item), title: this.item.text },
      React.createElement("input", { type: "radio", className: "sv-visuallyhidden", name: this.question.questionName, id: this.question.getInputId(this.index), value: this.item.value, disabled: this.question.isDisabledAttr, readOnly: this.question.isReadOnlyAttr, checked: this.question.value == this.item.value, onClick: this.props.handleOnClick, onChange: () => {
      }, "aria-label": this.question.ariaLabel }),
...
var RatingItemSmiley = class extends RatingItemBase {
  render() {
    return React.createElement(
      "label",
      { onMouseDown: this.handleOnMouseDown, style: this.question.getItemStyle(this.item.itemValue, this.item.highlight), className: this.question.getItemClass(this.item.itemValue), onMouseOver: (e) => this.question.onItemMouseIn(this.item), onMouseOut: (e) => this.question.onItemMouseOut(this.item), title: this.item.text },
      React.createElement("input", { type: "radio", className: "sv-visuallyhidden", name: this.question.questionName, id: this.question.getInputId(this.index), value: this.item.value, disabled: this.question.isDisabledAttr, readOnly: this.question.isReadOnlyAttr, checked: this.question.value == this.item.value, onClick: this.props.handleOnClick, onChange: () => {
      }, "aria-label": this.question.ariaLabel }),
...
var SurveyQuestionDropdownBase = class extends SurveyQuestionUncontrolledElement {
  ...
  renderOther(item, cssClasses) {
    ...
    return React.createElement(
      "div",
      { key: item.normalizedId, className: this.question.getCommentAreaCss(true) },
      React.createElement(SurveyQuestionCommentValueItem, { question: this.question, item, isDisplayMode: this.isDisplayMode, cssClasses: this.question.cssClasses, otherCss: this.question.getCommentAreaCss(false) })
    );
  }
  renderEditorButtons() {
...
var SurveyQuestionMatrixDropdownBase = class extends SurveyQuestionElementBase {
  ...
  renderTableDiv() {
    return React.createElement(
      "div",
      { className: this.question.cssClasses.tableWrapper, ref: (root) => this.setControl(root) },
...
var SurveyQuestionMatrixDropdownCell = class extends SurveyQuestionAndErrorsCell {
  ...
  renderOtherComment() {
    ...
    return React.createElement(SurveyQuestionCommentValueItem, { question, item: question.otherItem, cssClasses, otherCss: cssClasses.other, isDisplayMode: question.isInputReadOnly });
  }
...
var SurveyQuestionSlider = class extends SurveyQuestionElementBase {
  ...
  getInput(i) {
    ...
    const value = renderedValue[i];
    const input = React.createElement("input", { className: cssClasses.input, id: "sjs-slider-input-" + i, type: "range", min, max, step, value, onChange: (e) => {
  ...
  getRangeInput() {
    ...
    return React.createElement("input", { name: "range-input", id: "sjs-slider-input-range-input", ref: this.rangeInputRef, className: cssClasses.input, type: "range", "aria-hidden": "true", min, max, step, tabIndex: -1, onChange: (e) => {
...
var SliderLabelItem = class extends SurveyElementBase {
  ...
  renderElement() {
    ...
    return React.createElement(
      "div",
      { key: this.item.id, className: getLabelCss(locText), style: { left: getPercent(value) + "%" }, onPointerUp: (e) => {
...
var TabbedMenuComponent = class extends SurveyElementBase {
  ...
  constructor(props) {
    super(props);
    this.rootRef = React2.createRef();
  }
  renderElement() {
    const items = this.model.renderedActions.map((item) => React2.createElement(TabbedMenuItemWrapper, { item, key: item.renderedId }));
    return React2.createElement("div", { ref: this.rootRef, className: "svc-tabbed-menu", role: "tablist", style: this.model.getRootStyle() }, items);
  }
  componentDidUpdate(prevProps, prevState) {
    super.componentDidUpdate(prevProps, prevState);
    const container = this.rootRef.current;
...
var TabbedMenuItemWrapper = class extends SurveyElementBase {
  ...
  renderElement() {
    ...
    return React2.createElement(
      ...
      React2.createElement("div", { className: "sv-action__content" }, component)
    );
  }
  componentDidMount() {
    super.componentDidMount();
...
var TabbedMenuItemComponent = class extends SurveyElementBase {
  ...
  render() {
    const item = this.item;
    return attachKey2click(React2.createElement(
      "div",
      { role: "tab", id: "tab-" + item.id, "aria-selected": item.active, "aria-controls": "scrollableDiv-" + item.id, className: item.getRootCss(), onClick: () => item.action(item) },
      item.hasTitle ? React2.createElement("span", { className: item.getTitleCss() }, item.title) : null,
      item.hasIcon ? React2.createElement(SvgIcon, { iconName: item.iconName, className: item.getIconCss(), size: "auto", title: item.tooltip || item.title }) : null
    ));
  }
};
ReactElementFactory.Instance.registerElement("svc-tabbed-menu-item", (props) => {
  return React2.createElement(TabbedMenuItemComponent, props);
});
var SurveyCreatorComponent = class extends SurveyElementBase {
  constructor(props) {
    super(props);
    this.rootNode = React2.createRef();
  }
  get creator() {
    return this.props.creator;
  }
  ...
  renderElement() {
    ...
    if (!this.props.creator.haveCommercialLicense) {
      ...
      licenseBanner = React2.createElement(
        "div",
        { className: "svc-creator__banner" },
        React2.createElement("span", { className: "svc-creator__non-commercial-text", dangerouslySetInnerHTML: htmlValue })
      );
    }
    return React2.createElement(
      "div",
      { className: this.creator.getRootCss(), ref: this.rootNode, style: creatorStyles },
      React2.createElement(SvgBundleComponent, null),
      React2.createElement(PopupModal, null),
        ...
        React2.createElement(
          ...
          React2.createElement(
            ...
            React2.createElement(
              ...
              creator.showTabs ? React2.createElement(
                "div",
                { className: "svc-tabbed-menu-wrapper" },
                React2.createElement(TabbedMenuComponent, { model: creator.tabbedMenu })
              ) : null,
              creator.showToolbar ? React2.createElement(
                "div",
                { className: "svc-toolbar-wrapper" },
                React2.createElement(SurveyActionBar, { model: creator.toolbar })
              ) : null
            ),
            React2.createElement(
              "div",
              { className: contentWrapperClassName },
              React2.createElement("div", { className: "svc-creator__content-holder svc-flex-column" }, this.renderActiveTab())
            ),
            React2.createElement("div", { className: "svc-footer-bar" }, creator.isMobileView ? React2.createElement(
              "div",
              { className: "svc-toolbar-wrapper" },
              React2.createElement(SurveyActionBar, { model: creator.footerToolbar })
            ) : null)
          ),
          this.renderSidebar()
        ),
        licenseBanner,
        React2.createElement(NotifierComponent, { notifier: creator.notifier })
      )
    );
  }
  renderActiveTab() {
  ...
  renderCreatorTab(tab) {
    ...
    return React2.createElement("div", { role: "tabpanel", key: tab.id, id: "scrollableDiv-" + tab.id, "aria-labelledby": "tab-" + tab.id, className }, component);
  }
  renderSidebar() {
...
var SurveyCreator = class extends SurveyCreatorModel {
  ...
  renderError(key, error, cssClasses) {
    return React2.createElement(
      "div",
      { key },
      React2.createElement("span", { className: cssClasses.error.icon, "aria-hidden": "true" }),
      React2.createElement(
        "span",
        { className: cssClasses.error.item },
        React2.createElement(SurveyLocStringViewer, { locStr: error.locText })
      )
    );
  }
  questionTitleLocation() {
...
ReactElementFactory.Instance.registerElement("survey-widget", (props) => {
  return React2.createElement(Survey, props);
});
...
var RowWrapper = class extends CreatorModelElement {
  ...
  render() {
    return React2.createElement(
      ...
      React2.createElement("div", { className: "svc-row__drop-indicator svc-row__drop-indicator--top" }),
      React2.createElement("div", { className: "svc-row__drop-indicator svc-row__drop-indicator--bottom" }),
      this.props.element
    );
  }
};
ReactElementFactory.Instance.registerElement("svc-row", (props) => {
  return React2.createElement(RowWrapper, props);
});
...
var QuestionElementContent = React2.memo(QuestionElementContentFunc);
...
var QuestionAdornerComponent = class extends CreatorModelElement {
  ...
  renderContent(allowInteractions) {
    ...
    return attachKey2click(React2.createElement(
      ...
      React2.createElement("div", { className: "svc-question__drop-indicator svc-question__drop-indicator--left" }),
      React2.createElement("div", { className: "svc-question__drop-indicator svc-question__drop-indicator--right" }),
      React2.createElement("div", { className: "svc-question__drop-indicator svc-question__drop-indicator--top" }),
      React2.createElement("div", { className: "svc-question__drop-indicator svc-question__drop-indicator--bottom" }),
  ...
  renderQuestionTitle() {
    ...
    return React2.createElement("div", { ref: (node) => node && (!this.model.renderedCollapsed ? node.setAttribute("inert", "") : node.removeAttribute("inert")), className: this.model.cssCollapsedHiddenHeader }, element.hasTitle ? React2.createElement(TitleElement, { element }) : React2.createElement(
      "div",
      { className: this.model.cssCollapsedHiddenTitle },
      React2.createElement("span", { className: "svc-fake-title" }, element.name)
    ));
  }
  renderElementContent() {
    return React2.createElement(
      React2.Fragment,
      null,
      React2.createElement(QuestionElementContent, { element: this.props.element }),
  ...
  renderElementPlaceholder() {
    ...
    return React2.createElement(
      ...
      React2.createElement(
        ...
        React2.createElement("div", { className: "svc-panel__placeholder" }, this.model.placeholderText)
      )
    );
  }
  componentWillUnmount() {
...
ReactElementFactory.Instance.registerElement("svc-question", (props) => {
  return React2.createElement(QuestionAdornerComponent, props);
});
var QuestionWrapperHeader = class extends React2.Component {
  render() {
    ...
    return React2.createElement(
      ...
      React2.createElement(SvgIcon, { className: "svc-question__drag-element", size: "auto", iconName: "icon-drag-area-indicator_24x16" }),
      React2.createElement(
        "div",
        { className: "svc-question__top-actions" },
        React2.createElement(SurveyActionBar, { model: this.props.model.topActionContainer, handleClick: false })
      )
    );
  }
};
ReactElementFactory.Instance.registerElement("svc-question-header", (props) => {
  return React2.createElement(QuestionWrapperHeader, props);
});
var QuestionWrapperFooter = class extends React2.Component {
  render() {
    return React2.createElement(
      "div",
      { className: this.props.className, onFocus: (e) => this.props.model.select(this.props.model, new ReactMouseEvent(e)) },
      React2.createElement(SurveyActionBar, { model: this.props.model.actionContainer, handleClick: false })
    );
  }
};
ReactElementFactory.Instance.registerElement("svc-question-footer", (props) => {
  return React2.createElement(QuestionWrapperFooter, props);
});
var ActionButton = class extends SurveyElementBase {
  ...
  renderButtonText(classes) {
    if (this.props.disabled) {
      return React2.createElement("span", { className: classes }, this.props.text);
    }
    return React2.createElement(React2.Fragment, null, attachKey2click(React2.createElement("span", { role: "button", className: classes, onClick: (e) => {
  ...
  renderIcon(classes) {
    ...
    if (this.props.disabled) {
      return React2.createElement(
        "span",
        { className: classes },
        React2.createElement(SvgIcon, { size: "auto", iconName: this.props.iconName })
      );
    }
    return React2.createElement(React2.Fragment, null, attachKey2click(React2.createElement(
      "span",
...
ReactElementFactory.Instance.registerElement("svc-action-button", (props) => {
  return React2.createElement(ActionButton, props);
});
var QuestionBanner = class extends React2.Component {
  render() {
    return React2.createElement(
      "div",
      ...
      React2.createElement(
        ...
        React2.createElement(
          ...
          React2.createElement(ActionButton, { click: () => this.props.onClick(), text: this.props.actionText })
        )
      )
    );
  }
...
ReactElementFactory.Instance.registerElement("svc-question-banner", (props) => {
  return React2.createElement(QuestionBanner, props);
});
  ...
  renderElementPlaceholder() {
    ...
    return React2.createElement(
      ...
      React2.createElement(
        "div",
        null,
        React2.createElement("div", { className: "svc-question__dropdown-choices" }, (this.dropdownModel.getRenderedItems() || []).map((item, index) => React2.createElement("div", { className: this.dropdownModel.getChoiceCss(), key: `editable_choice_${index}` }, ReactSurveyElementsWrapper.wrapItemValue(this.question.survey, ReactElementFactory.Instance.createElement(this.dropdownModel.itemComponent, {
          key: item.value,
          question: this.question,
        ...
        this.dropdownModel.needToCollapse ? React2.createElement(ActionButton, { click: this.dropdownModel.switchCollapse, text: this.dropdownModel.getButtonText(), allowBubble: true }) : null
      )
    );
  }
};
ReactElementFactory.Instance.registerElement("svc-dropdown-question", (props) => {
  return React2.createElement(QuestionDropdownAdornerComponent, props);
});
var QuestionImageAdornerComponent = class extends QuestionAdornerComponent {
  ...
  renderHeader() {
    return React2.createElement(
      React2.Fragment,
      null,
      React2.createElement("input", { type: "file", "aria-hidden": "true", tabIndex: -1, accept: this.imageModel.acceptedTypes, className: "svc-choose-file-input", style: {
        position: "absolute",
        opacity: 0,
        width: "1px",
        height: "1px",
  ...
  renderLoadingPlaceholder() {
    return React2.createElement(
      ...
      React2.createElement(
        ...
        React2.createElement(LoadingIndicatorComponent, null)
      )
    );
  }
  renderChooseButton() {
    return React2.createElement("div", { className: "svc-image-question-controls" }, this.model.allowEdit ? attachKey2click(React2.createElement(
      "span",
      { className: "svc-context-button", onClick: () => this.imageModel.chooseFile(this.imageModel) },
      React2.createElement(SvgIcon, { size: "auto", iconName: "icon-choosefile" })
    )) : null);
  }
  renderElementPlaceholder() {
  ...
  renderElementContent() {
    if (this.imageModel.isEmptyImageLink) {
      ...
      return React2.createElement(React2.Fragment, null, fileQuestion);
    } else {
      return React2.createElement(
        React2.Fragment,
        null,
...
ReactElementFactory.Instance.registerElement("svc-image-question", (props) => {
  return React2.createElement(QuestionImageAdornerComponent, props);
});
    ...
    return React2.createElement(
      ...
      React2.createElement(
        ...
        React2.createElement(
          ...
          model.allowRemove ? attachKey2click(React2.createElement(
            "span",
            { role: "button", className: model.removeClassNames, "aria-label": model.removeTooltip, onClick: () => model.removeItem(model) },
            React2.createElement(SvgIcon, { size: "auto", iconName: "icon-remove_16x16", title: model.removeTooltip })
          )) : null,
          model.allowAdd ? attachKey2click(React2.createElement(
            "span",
            { role: "button", className: model.addClassNames, "aria-label": model.addTooltip, onClick: () => model.addItem(model) },
            React2.createElement(SvgIcon, { size: "auto", iconName: "icon-add_16x16", title: model.addTooltip })
          )) : null
        ),
        this.props.element
      )
...
ReactElementFactory.Instance.registerElement("svc-rating-question", (props) => {
  return React2.createElement(QuestionRatingAdornerComponent, props);
});
...
var QuestionWidgetAdornerComponent = class extends QuestionAdornerComponent {
  ...
  renderElementContent() {
    return React2.createElement("div", { className: "svc-widget__content" }, this.props.element);
  }
};
ReactElementFactory.Instance.registerElement("svc-widget-question", (props) => {
  return React2.createElement(QuestionWidgetAdornerComponent, props);
});
  ...
  render() {
    return React2.createElement(
      ...
      React2.createElement(
        ...
        React2.createElement("div", { className: " svc-question__content--in-popup svc-question__content" }, this.props.element)
      )
    );
  }
};
ReactElementFactory.Instance.registerElement("svc-cell-question", (props) => {
  return React2.createElement(CellQuestionAdornerComponent, props);
});
    ...
    return React2.createElement(
      ...
      React2.createElement(
        ...
        React2.createElement(
          ...
          this.props.element,
          React2.createElement("div", { className: "svc-question__dropdown-choices" }, question.visibleChoices.map((item, index) => React2.createElement("div", { className: "svc-question__dropdown-choice", key: `editable_choice_${index}` }, ReactSurveyElementsWrapper.wrapItemValue(question.survey, ReactElementFactory.Instance.createElement("survey-radiogroup-item", {
            question,
...
ReactElementFactory.Instance.registerElement("svc-cell-dropdown-question", (props) => {
  return React2.createElement(CellQuestionDropdownAdornerComponent, props);
});
var PageElementContent = React2.memo(({ page, survey, creator }) => {
  return React2.createElement(SurveyPage, { page, survey, creator });
});
...
var CreatorSurveyPageComponent = class extends CreatorModelElement {
  ...
  renderContent() {
    ...
    return React2.createElement(PageElementContent, { page: this.props.page, survey: this.props.survey, creator: this.props.creator });
  }
  renderHeader() {
    const actions = React2.createElement(
      "div",
      { className: "svc-page__content-actions" },
      React2.createElement(SurveyActionBar, { model: this.model.actionContainer }),
      this.model.topActionContainer.hasActions ? React2.createElement(SurveyActionBar, { model: this.model.topActionContainer }) : null
    );
  ...
  renderFooter() {
    return React2.createElement(SurveyActionBar, { model: this.model.footerActionsBar });
  }
};
ReactElementFactory.Instance.registerElement("svc-page", (props) => {
  return React2.createElement(CreatorSurveyPageComponent, props);
});
  ...
  renderTypeSelector() {
    ...
    return attachKey2click(React2.createElement(
      ...
      React2.createElement(
        ...
        React2.createElement(SvgIcon, { iconName: questionTypeSelectorModel.iconName, size: "auto", title: this.model.addNewQuestionText })
      ),
      this.props.renderPopup === void 0 || this.props.renderPopup ? React2.createElement(Popup, { model: questionTypeSelectorModel.popupModel }) : null
    ));
  }
  renderElement() {
    ...
    return React2.createElement(
      React2.Fragment,
      null,
      attachKey2click(React2.createElement(
        "div",
        ...
        React2.createElement(SvgIcon, { className: "svc-panel__add-new-question-icon", iconName: "icon-add_24x24", size: "auto" }),
        React2.createElement("span", { className: "svc-add-new-item-button__text" }, this.model.addNewQuestionText),
...
ReactElementFactory.Instance.registerElement("svc-add-new-question-btn", (props) => {
  return React2.createElement(AddQuestionButtonComponent, props);
});
var PanelAdornerComponent = class extends QuestionAdornerComponent {
  renderElementPlaceholder() {
    ...
    return React2.createElement(
      ...
      React2.createElement(
        ...
        { className: "svc-panel__placeholder_frame" },
        React2.createElement("div", { className: "svc-panel__placeholder" }, this.model.placeholderText),
        this.model.showAddQuestionButton ? attachKey2click(React2.createElement(
          "div",
  ...
  renderFooter() {
    return React2.createElement(
      React2.Fragment,
      null,
      !this.model.isEmptyElement && this.model.element.isPanel && this.model.showAddQuestionButton ? React2.createElement(
        "div",
        { className: "svc-panel__add-new-question-container" },
        React2.createElement(
          "div",
          { className: "svc-panel__question-type-selector-popup" },
          React2.createElement(Popup, { model: this.model.questionTypeSelectorModel.popupModel })
        ),
        React2.createElement(
          "div",
          { className: "svc-panel__add-new-question-wrapper" },
          React2.createElement(AddQuestionButtonComponent, { item: { data: this.model }, buttonClass: "svc-action-button", renderPopup: false })
        )
      ) : null,
      super.renderFooter()
    );
...
ReactElementFactory.Instance.registerElement("svc-panel", (props) => {
  return React2.createElement(PanelAdornerComponent, props);
});
var LogoImageComponent = class extends CreatorModelElement {
  ...
  renderClearButton() {
    return attachKey2click(React2.createElement(
      ...
      React2.createElement(SvgIcon, { size: "auto", iconName: "icon-clear" })
    ));
  }
  renderButtons() {
    return React2.createElement(
  ...
  renderImage() {
    return React2.createElement(
      ...
      this.renderButtons(),
      React2.createElement(LogoImage, { data: this.props.data.survey })
    );
  }
  renderPlaceHolder() {
    return this.model.allowEdit && !this.model.isUploading ? attachKey2click(React2.createElement(
      "div",
      { className: "svc-logo-image-placeholder", onClick: () => this.model.chooseFile(this.model) },
      React2.createElement(
        "svg",
        null,
        React2.createElement("use", { xlinkHref: "#icon-image-48x48" })
      )
    )) : null;
  }
  renderInput() {
    return React2.createElement("input", { "aria-hidden": "true", type: "file", tabIndex: -1, accept: this.model.acceptedTypes, className: "svc-choose-file-input" });
  }
  renderLoadingIndicator() {
    return React2.createElement(
      "div",
...
ReactElementFactory.Instance.registerElement("svc-logo-image", (props) => {
  return React2.createElement(LogoImageComponent, props);
});
var SurveyQuestionLinkValue = class extends SurveyQuestionElementBase {
  ...
  renderClear() {
    ...
    if (!this.questionBase.isReadOnly && showClear) {
      return React2.createElement(ActionButton, { classes: this.question.linkClearButtonCssClasses, click: () => this.question.doClearClick(), text: editorLocalization.getString("pe.clear") });
    } else {
      return null;
    }
  }
  renderElement() {
    return React2.createElement(
      React2.Fragment,
      null,
      React2.createElement(ActionButton, { classes: this.question.linkSetButtonCssClasses, click: () => this.question.doLinkClick(), selected: this.question.isSelected, disabled: !this.question.isClickable, text: this.question.linkValueText, title: this.question.tooltip, iconName: this.question.iconName }),
      this.renderClear()
    );
  }
};
ReactQuestionFactory.Instance.registerQuestion("linkvalue", (props) => {
  return React2.createElement(SurveyQuestionLinkValue, props);
});
var SurveyElementEmbeddedSurvey = class extends SurveyQuestionElementBase {
  ...
  render() {
    ...
    if (!survey || !survey.currentPage)
      return null;
    return React2.createElement(SurveyPage, { survey, page: survey.currentPage, css: survey.css, creator: this.creator });
  }
};
ReactQuestionFactory.Instance.registerQuestion("embeddedsurvey", (props) => {
  return React2.createElement(SurveyElementEmbeddedSurvey, props);
});
var QuestionEditorContentComponent = class extends React2.Component {
  get survey() {
    return this.props.survey;
  }
  createQuestionElement(question) {
  ...
  render() {
    ...
    return React2.createElement(
      ...
      React2.createElement(SurveyQuestion, { creator: this, element: question })
    );
  }
};
ReactElementFactory.Instance.registerElement("svc-question-editor-content", (props) => {
  return React2.createElement(QuestionEditorContentComponent, props);
});
var ItemValueAdornerComponent = class extends CreatorModelElement {
  ...
  render() {
    ...
    const button = this.model.allowAdd ? attachKey2click(React2.createElement(
      "span",
      ...
      React2.createElement(SvgIcon, { size: "auto", iconName: "icon-add_16x16", title: this.model.tooltip })
    )) : React2.createElement(
      React2.Fragment,
      null,
      " ",
      this.model.isDraggable ? React2.createElement(
        "span",
        { className: "svc-item-value-controls__button svc-item-value-controls__drag" },
        React2.createElement(SvgIcon, { className: "svc-item-value-controls__drag-icon", size: "auto", iconName: "icon-drag-24x24", title: this.model.dragTooltip })
      ) : null,
      this.model.allowRemove ? attachKey2click(React2.createElement(
        "span",
        ...
        React2.createElement(SvgIcon, { size: "auto", iconName: "icon-remove_16x16", title: this.model.tooltip })
      )) : null
    );
    ...
    return React2.createElement(
      ...
      React2.createElement("div", { className: "svc-item-value__ghost" }),
      React2.createElement("div", { className: "svc-item-value-controls", onBlur: this.onBlur }, button),
      React2.createElement("div", { className: "svc-item-value__item", onClick: (event) => this.model.select(this.model, event.nativeEvent) }, this.props.element)
    );
  }
};
ReactElementFactory.Instance.registerElement("svc-item-value", (props) => {
  return React2.createElement(ItemValueAdornerComponent, props);
});
var ImageItemValueAdornerComponent = class extends CreatorModelElement {
  ...
  renderNewItemControls() {
    const addButton = attachKey2click(React2.createElement("span", { className: this.model.addButtonCss, onClick: () => this.model.chooseNewFile(this.model) }, this.model.showChooseButtonAsIcon ? React2.createElement(SvgIcon, { size: "auto", iconName: "icon-add-lg", title: this.model.addFileTitle }) : React2.createElement("span", null, this.model.chooseImageText)));
    const placeholder = this.model.showPlaceholder ? React2.createElement("span", { className: "svc-image-item-value__placeholder" }, this.model.placeholderText) : null;
    return React2.createElement(
      React2.Fragment,
      null,
      placeholder,
  ...
  render() {
        ...
        React2.createElement(
          ...
          React2.createElement(
            ...
            React2.createElement(
              ...
              React2.createElement("div", { style: imageStyle, className: "sd-imagepicker__image" }, this.model.isUploading ? this.renderLoadingIndicator() : null)
            )
          )
        ),
        this.model.allowAdd && !this.model.isUploading ? React2.createElement("div", { className: "svc-image-item-value-controls" }, this.renderNewItemControls()) : null
      );
    } else {
      content = React2.createElement(
        React2.Fragment,
        null,
        React2.createElement("div", { className: "svc-image-item-value__item" }, this.props.element),
        this.model.isDraggable && this.model.canRenderControls ? React2.createElement(
          "span",
          ...
          React2.createElement(SvgIcon, { size: "auto", iconName: "icon-drag-24x24" })
        ) : null,
        this.model.canRenderControls ? React2.createElement(
          "div",
          { className: "svc-context-container svc-image-item-value-controls" },
          this.model.allowRemove && !this.model.isUploading ? attachKey2click(React2.createElement(
            "span",
            { className: "svc-context-button", onClick: () => this.model.chooseFile(this.model) },
            React2.createElement(SvgIcon, { role: "button", size: "auto", iconName: "icon-choosefile", title: this.model.selectFileTitle })
          )) : null,
          this.model.allowRemove && !this.model.isUploading ? attachKey2click(React2.createElement(
            "span",
            { className: "svc-context-button svc-context-button--danger", onClick: () => this.model.remove(this.model) },
            React2.createElement(SvgIcon, { role: "button", size: "auto", iconName: "icon-delete", title: this.model.removeFileTitle })
          )) : null
        ) : null
      );
    }
    return React2.createElement(
      ...
      React2.createElement("div", { className: "svc-image-item-value-wrapper__ghost", style: imageStyle }),
      React2.createElement(
        "div",
        { className: "svc-image-item-value-wrapper__content" },
        React2.createElement("input", { type: "file", "aria-hidden": "true", tabIndex: -1, accept: this.model.acceptedTypes, className: "svc-choose-file-input", style: {
          position: "absolute",
          opacity: 0,
          width: "1px",
          height: "1px",
...
ReactElementFactory.Instance.registerElement("svc-image-item-value", (props) => {
  return React2.createElement(ImageItemValueAdornerComponent, props);
});
var MatrixCellAdornerComponent = class extends CreatorModelElement {
  ...
  render() {
    ...
    if (!!this.model.isSupportCellEditor) {
      controls = React2.createElement("div", { className: "svc-matrix-cell__question-controls" }, attachKey2click(React2.createElement(
        "span",
        ...
        React2.createElement(SvgIcon, { size: "auto", iconName: "icon-edit" })
      )));
    }
    return React2.createElement(
      "div",
      ...
      React2.createElement("div", { className: "svc-matrix-cell--selected" + (this.model.isSelected ? " svc-visible" : "") }),
      this.props.element,
      controls
    );
  }
...
ReactElementFactory.Instance.registerElement("svc-matrix-cell", (props) => {
  return React2.createElement(MatrixCellAdornerComponent, props);
});
var SurveyResults = class _SurveyResults extends CreatorModelElement {
    ...
    return React2.createElement(
      ...
      React2.createElement(
        ...
        React2.createElement(
          ...
          React2.createElement("div", { className: "svd-test-results__header-text" }, this.model.surveyResultsText),
          React2.createElement(
            "div",
            { className: "svd-test-results__header-types" },
            React2.createElement(ActionButton, { click: () => this.model.selectTableClick(), text: this.model.surveyResultsTableText, selected: this.model.isTableSelected, disabled: false }),
            React2.createElement(ActionButton, { click: () => this.model.selectJsonClick(), text: this.model.surveyResultsJsonText, selected: this.model.isJsonSelected, disabled: false })
          )
        ),
  ...
  renderResultAsText() {
    ...
    return React2.createElement(
      ...
      React2.createElement("div", null, this.model.resultText)
    );
  }
  renderResultAsTable() {
      ...
      React2.createElement(
        ...
        React2.createElement(
          ...
          React2.createElement(
            ...
            React2.createElement("th", { key: 1, className: "svd-dark-border-color" }, this.model.resultsTitle),
            React2.createElement("th", { key: 2, className: "svd-dark-border-color" }, this.model.resultsDisplayValue)
          )
        ),
        React2.createElement("tbody", null, _SurveyResults.renderRows(this.model.resultData))
      )
    );
  }
  static renderRows(data) {
    ...
    for (var i = 0; i < data.length; i++) {
      rows.push(React2.createElement(SurveyResultsByRow, { key: i + 1, row: data[i] }));
    }
    return rows;
  }
};
    ...
    return React2.createElement(
      ...
      attachKey2click(React2.createElement(
        ...
        React2.createElement(
          ...
          this.row.isNode ? React2.createElement(
            "span",
            { style: { left: this.row.markerMargin }, className: "svd-test-results__marker " + (this.row.collapsed ? "" : "svd-test-results__marker--expanded") },
            React2.createElement(SvgIcon, { iconName: "icon-expand_16x16", size: 16 })
          ) : null,
          this.row.question ? React2.createElement(SurveyLocStringViewer, { locStr: this.row.question.locTitle }) : React2.createElement("span", null, this.row.title)
        ),
        React2.createElement("td", { key: 2, className: this.row.isNode ? "svd-test-results__node-value" : "svd-dark-border-color" }, this.row.getString(this.row.displayValue))
      )),
...
var SurveyCreatorToolboxTool = class extends CreatorModelElement {
  ...
  render() {
    ...
    return React2.createElement(
      ...
      item.needSeparator && !this.creator.toolbox.showCategoryTitles ? React2.createElement("div", { className: "svc-toolbox__category-separator" }) : null,
      React2.createElement("div", { className: "svc-toolbox__tool-content sv-action__content", onPointerDown: (event) => {
        event.persist();
...
var SurveyCreatorToolboxItem = class extends CreatorModelElement {
  ...
  render() {
    const banner = this.props.isCompact ? React2.createElement(
      "span",
      { className: "svc-toolbox__item-banner", onClick: (event) => {
        event.persist();
        this.model.click(event);
      } },
      React2.createElement(SvgIcon, { size: "auto", iconName: this.item.iconName, className: "svc-toolbox__item-icon", title: this.item.tooltip }),
      React2.createElement("span", null, this.item.title)
    ) : null;
    const item = attachKey2click(React2.createElement(
      "div",
      { className: this.item.renderedCss, tabIndex: 0, role: "button", "aria-label": this.item.tooltip, onClick: (event) => {
        event.persist();
        this.model.click(event);
      } },
      React2.createElement("span", { className: "svc-toolbox__item-container" }, !!this.item.iconName ? React2.createElement(SvgIcon, { size: "auto", iconName: this.item.iconName, className: "svc-toolbox__item-icon" }) : null),
      this.props.isCompact ? null : React2.createElement("span", { className: "svc-toolbox__item-title" }, this.item.title)
    ));
    return React2.createElement(
      React2.Fragment,
      null,
...
ReactElementFactory.Instance.registerElement("svc-toolbox-item", (props) => {
  return (0, import_react.createElement)(SurveyCreatorToolboxItem, props);
});
var SurveyCreatorToolboxItemGroup = class extends CreatorModelElement {
  ...
  render() {
    return React2.createElement(
      React2.Fragment,
      null,
      React2.createElement(SurveyCreatorToolboxItem, { item: this.item, creator: this.creator, model: this.model, parentModel: this.parentModel, isCompact: this.isCompact }),
      React2.createElement(
        "div",
        ...
        React2.createElement(SvgIcon, { size: "auto", iconName: this.item.subitemsButtonIcon }),
        React2.createElement(Popup, { model: this.item.popupModel })
      )
    );
  }
};
ReactElementFactory.Instance.registerElement("svc-toolbox-item-group", (props) => {
  return React2.createElement(SurveyCreatorToolboxItemGroup, props);
});
var SurveyCreatorToolboxCategory = class extends SurveyElementBase {
  ...
  render() {
    ...
    return React2.createElement(
      ...
      React2.createElement("div", { className: "svc-toolbox__category-header-wrapper" }, header),
      items
    );
  }
  renderCategoryHeader() {
    ...
    return attachKey2click(React2.createElement(
      ...
      React2.createElement("span", { className: "svc-toolbox__category-title" }, this.category.title),
      this.renderButton()
    ));
  }
  renderButton() {
    ...
    return React2.createElement(
      ...
      React2.createElement(SvgIcon, { className: this.category.iconClassName, iconName, size: "auto" })
    );
  }
  ...
  renderItems(items, isCompact = false) {
    return items.map((item, itemIndex) => React2.createElement(SurveyCreatorToolboxTool, { item, creator: this.toolbox.creator, parentModel: this.toolbox, isCompact, key: "item" + itemIndex }));
  }
};
ReactElementFactory.Instance.registerElement("svc-toolbox-category", (props) => {
  return React2.createElement(SurveyCreatorToolboxCategory, props);
});
var ToolboxList = class extends SurveyElementBase {
  ...
  render() {
    if (!this.model || !this.model.renderElements)
      return null;
    const items = this.renderItems();
    return React2.createElement("div", { className: this.model.cssClasses.root }, items);
  }
  renderItems() {
    const items = this.model.renderedActions;
    return items.map((item, itemIndex) => React2.createElement(SurveyCreatorToolboxTool, { item, creator: this.creator, parentModel: this.model, isCompact: false, key: "item" + itemIndex }));
  }
};
ReactElementFactory.Instance.registerElement("svc-toolbox-list", (props) => {
  return React2.createElement(ToolboxList, props);
});
  ...
  renderElement() {
    ...
    return React2.createElement(
      ...
      React2.createElement(
        ...
        React2.createElement(SvgIcon, { iconName: "icon-search", size: "auto" })
      ),
      React2.createElement("input", { type: "text", className: "svc-search__input", "aria-label": this.model.filterStringPlaceholder, placeholder: this.model.filterStringPlaceholder, value: this.state.filterString, onChange }),
      React2.createElement(
        "div",
        { className: "svc-search__toolbar" },
        React2.createElement("div", { className: "svc-search__toolbar-counter" }, this.model.matchCounterText),
        React2.createElement(SurveyActionBar, { model: this.model.searchActionBar })
      )
    );
  }
};
ReactElementFactory.Instance.registerElement("svc-search", (props) => {
  return React2.createElement(SearchComponent, props);
});
var AdaptiveToolbox = class extends SurveyElementBase {
  ...
  renderItems(items, isCompact = false) {
    return items.map((item, itemIndex) => {
      return React2.createElement(SurveyCreatorToolboxTool, { item, creator: this.creator, parentModel: this.toolbox, isCompact, key: item.renderedId });
    });
  }
  renderCategories() {
  ...
  renderSearch() {
    const searchButton = this.toolbox.isCompactRendered ? React2.createElement(
      React2.Fragment,
      null,
      React2.createElement(SurveyCreatorToolboxTool, { item: this.toolbox.searchItem, creator: this.creator, parentModel: this.toolbox, isCompact: this.toolbox.isCompactRendered, key: "searchitem" })
    ) : null;
    return React2.createElement(
      "div",
      { className: "svc-toolbox__search-container" },
      searchButton,
      React2.createElement(SearchComponent, { model: this.toolbox.searchManager }),
      React2.createElement("div", { className: "svc-toolbox__category-separator svc-toolbox__category-separator--search" })
    );
  }
  render() {
    const search = this.toolbox.showSearch ? this.renderSearch() : null;
    const placeholder = this.toolbox.showPlaceholder ? React2.createElement("div", { className: "svc-toolbox__placeholder" }, this.toolbox.toolboxNoResultsFound) : null;
    return React2.createElement(
      "div",
      ...
      React2.createElement(
        ...
        search,
        placeholder,
        React2.createElement(Scroll, null, this.toolbox.showInSingleCategory ? React2.createElement("div", { className: "svc-toolbox__category" }, this.renderItems(this.toolbox.renderedActions, this.toolbox.isCompactRendered)) : this.renderCategories())
      )
    );
  }
};
ReactElementFactory.Instance.registerElement("svc-toolbox", (props) => {
  return React2.createElement(AdaptiveToolbox, props);
});
...
var TabButtonComponent = class extends SurveyElementBase {
  ...
  renderElement() {
    ...
    if (!model.visible)
      return null;
    const button = attachKey2click(React2.createElement(
      "div",
      ...
      React2.createElement(
        ...
        React2.createElement(
          ...
          React2.createElement(SvgIcon, { iconName: model.iconName, size: "auto" })
        )
      )
    ), model);
    return React2.createElement("div", { className: "svc-menu-action" }, button);
  }
};
    ...
    return React2.createElement(
      ...
      React2.createElement(
        ...
        React2.createElement(
          ...
          React2.createElement(TabButtonComponent, { model: this.props.model.expandCollapseAction })
        ),
        React2.createElement(
          "div",
        ...
        React2.createElement(
          ...
          React2.createElement(
            ...
            React2.createElement(TabsComponent, { model: this.props.model.topToolbar })
          )
        )
      ),
      React2.createElement(
        ...
        React2.createElement(
          "div",
          { className: "svc-sidebar-tabs__items" },
          React2.createElement(TabsComponent, { model: this.props.model.bottomToolbar })
        )
      )
    );
  }
...
ReactElementFactory.Instance.registerElement("svc-tab-control", (props) => {
  return React2.createElement(TabControl, props);
});
var TabsComponent = class extends SurveyElementBase {
  ...
  renderElement() {
    return React2.createElement(React2.Fragment, null, this.props.model.actions.map((item, itemIndex) => React2.createElement(TabButtonComponent, { model: item, key: "item" + itemIndex })));
  }
};
var SideBarDefaultHeader = class extends SurveyElementBase {
  ...
  renderElement() {
    const title = !!this.model.title ? React2.createElement("div", { className: "svc-side-bar__container-title" }, this.model.title) : null;
    return React2.createElement(
      "div",
      ...
      React2.createElement(
        ...
        React2.createElement(SurveyActionBar, { model: this.model.toolbar })
      ),
      title
    );
  }
...
ReactElementFactory.Instance.registerElement("svc-side-bar-default-header", (props) => {
  return React2.createElement(SideBarDefaultHeader, props);
});
  ...
  renderElement() {
    const button = attachKey2click(React2.createElement(
      ...
      React2.createElement(
        ...
        React2.createElement("span", { className: "svc-sidebar__header-title" }, this.objectSelectionAction.title),
        React2.createElement("span", { className: "svc-sidebar__header-subtitle" }, this.objectSelectionAction.tooltip)
      )
    ), this.props.model);
    return React2.createElement(
      "div",
      ...
      React2.createElement(
        ...
        React2.createElement(
          ...
          button,
          React2.createElement(Popup, { model: this.objectSelectionAction.popupModel })
        )
      )
    );
  }
...
ReactElementFactory.Instance.registerElement("svc-side-bar-property-grid-header", (props) => {
  return React2.createElement(SideBarPropertyGridHeader, props);
});
var SideBarHeader = class extends SurveyElementBase {
  ...
  renderElement() {
    return React2.createElement("div", { className: "svc-side-bar__container-header svc-sidebar__header-container" }, this.model.subTitle ? React2.createElement(
      "div",
      { className: "svc-sidebar__header-caption" },
      React2.createElement("span", { className: "svc-sidebar__header-title" }, this.model.title),
      React2.createElement("span", { className: "svc-sidebar__header-subtitle" }, this.model.subTitle)
    ) : React2.createElement("div", { className: "svc-side-bar__container-title" }, this.model.title));
  }
};
ReactElementFactory.Instance.registerElement("svc-side-bar-header", (props) => {
  return React2.createElement(SideBarHeader, props);
});
var SidebarComponent = class extends SurveyElementBase {
  ...
  constructor(props) {
    super(props);
    this.containerRef = React2.createRef();
  }
  getStateElement() {
    return this.model;
  }
  ...
  renderElement() {
    ...
    const items = this.model.pages.map((page) => React2.createElement(SidebarPage, { page, key: page.id }));
    ...
    return React2.createElement(
      ...
      React2.createElement("div", { className: "svc-side-bar__shadow", onClick: () => this.model.collapseSidebar(), style: containerStyle }),
      React2.createElement(
        "div",
        ...
        React2.createElement(
          ...
          React2.createElement(
            ...
            headerArea,
            React2.createElement("div", { className: "svc-side-bar__container-content" }, items)
          )
        ),
        sideArea
      )
...
ReactQuestionFactory.Instance.registerQuestion("svc-side-bar-page", (props) => {
  return React2.createElement(SidebarPage, props);
});
ReactElementFactory.Instance.registerElement("svc-side-bar", (props) => {
  return React2.createElement(SidebarComponent, props);
});
var TranslationLineSkeleton = class extends React2.Component {
  render() {
    return React2.createElement("div", { className: "sd-translation-line-skeleton" });
  }
};
ReactElementFactory.Instance.registerElement("sd-translation-line-skeleton", (props) => {
  return React2.createElement(TranslationLineSkeleton, props);
});
var TranslateFromAction = class extends SurveyElementBase {
  ...
  renderElement() {
    ...
    return React2.createElement(
      ...
      React2.createElement("span", { className: item.data.additionalTitleCss }, item.data.additionalTitle),
...
ReactElementFactory.Instance.registerElement("svc-translate-from-action", (props) => {
  return React2.createElement(TranslateFromAction, props);
});
var SurveyLocStringEditor2 = class extends CreatorModelElement {
  constructor(props) {
    var _a;
    super(props);
    this.onChangedHandler = (sender, options) => {
    ...
    this.state = { changed: 0 };
    this.svStringEditorRef = React2.createRef();
  }
  createModel(props) {
    if (this.baseModel) {
  ...
  render() {
    ...
    if (this.locString.hasHtml) {
      ...
      control = React2.createElement("span", {
        role: "textbox",
    ...
    const counter = this.baseModel.showCharacterCounter ? React2.createElement(CharacterCounterComponent, { counter: this.baseModel.characterCounter, remainingCharacterCounter: this.baseModel.getCharacterCounterClass }) : null;
    return React2.createElement(
      "span",
      ...
      React2.createElement(
        ...
        React2.createElement("div", { className: "svc-string-editor__border svc-string-editor__border--hover", onClick: this.edit }),
        React2.createElement("div", { className: "svc-string-editor__border svc-string-editor__border--focus", onClick: this.edit }),
        React2.createElement(
          "span",
          { className: "svc-string-editor__input" },
          control,
          React2.createElement("div", { className: "svc-string-editor__controls", onClick: this.edit }),
          counter
        )
      ),
      this.errorText ? React2.createElement("span", { className: "svc-string-editor__error" }, this.errorText) : ""
    );
  }
};
ReactElementFactory.Instance.registerElement(editableStringRendererName, (props) => {
  return React2.createElement(SurveyLocStringEditor2, props);
});
var QuestionErrorComponent2 = class extends React2.Component {
  render() {
    return React2.createElement(
      "div",
      null,
      React2.createElement(SvgIcon, { "aria-hidden": "true", iconName: "icon-alert_24x24", size: "24", className: this.props.cssClasses.error.icon }),
      React2.createElement(
        "span",
        { className: this.props.cssClasses.error.item || void 0 },
        React2.createElement(SurveyLocStringViewer, { locStr: this.props.error.locText })
      )
    );
  }
};
ReactElementFactory.Instance.registerElement("svc-question-error", (props) => {
  return React2.createElement(QuestionErrorComponent2, props);
});
var SurveyLogicOpertor = class extends SurveyQuestionDropdown {
  ...
  renderInput() {
    ...
    return React2.createElement(
      ...
      React2.createElement("div", { className: this.question.cssClasses.controlValue }, text)
    );
  }
  renderEditorButtons() {
    return null;
...
ReactQuestionFactory.Instance.registerQuestion("sv-logic-operator", (props) => {
  return React2.createElement(SurveyLogicOpertor, props);
});
    ...
    return React2.createElement(
      ...
      React2.createElement(
        ...
        attachKey2click(React2.createElement(
          ...
          React2.createElement(SvgIcon, { className: "svc-page-navigator__button-icon", iconName: this.model.icon, size: "auto", title: this.model.pageSelectorCaption })
        )),
        React2.createElement(Popup, { model: this.model.popupModel })
      ),
      React2.createElement("div", null, this.model.visibleItems.map((item) => React2.createElement(SurveyPageNavigatorItem, { key: item.id, item })))
    );
  }
};
var SurveyPageNavigatorItem = class extends CreatorModelElement {
  ...
  renderElement() {
    ...
    return React2.createElement("div", { className: "svc-page-navigator-item" }, attachKey2click(React2.createElement(
      "div",
      ...
      React2.createElement(
        ...
        React2.createElement("div", { className: "svc-page-navigator-item__dot-content" })
      ),
      React2.createElement(
        "div",
        { className: "svc-page-navigator-item__banner" },
        React2.createElement("span", { className: "svc-page-navigator-item__text" }, item.title),
        React2.createElement(
          "span",
          { className: "svc-page-navigator-item__dot" },
          React2.createElement("span", { className: "svc-page-navigator-item__dot-content" })
        )
      )
    )));
  }
};
var SurfacePlaceholder = class extends React2.Component {
  constructor(props) {
    super(props);
  }
  render() {
    return React2.createElement(
      ...
      React2.createElement("div", { className: "svc-surface-placeholder__image svc-surface-placeholder__image--" + this.props.name }),
      React2.createElement(
        "div",
        { className: "svc-surface-placeholder__text" },
        React2.createElement("div", { className: "svc-surface-placeholder__title" }, this.props.placeholderTitleText),
        React2.createElement("div", { className: "svc-surface-placeholder__description" }, this.props.placeholderDescriptionText)
      )
    );
  }
};
ReactElementFactory.Instance.registerElement("svc-surface-placeholder", (props) => {
  return React2.createElement(SurfacePlaceholder, props);
});
var TabDesignerComponent = class extends SurveyElementBase {
  ...
  createRenderedPage(page, isGhostPage) {
    return React2.createElement("div", { className: "svc-page", "data-sv-drop-target-page": page.name, "data-sv-drop-target-survey-element": isGhostPage ? "newGhostPage" : page.name, key: page.id }, this.renderPage(page, isGhostPage));
  }
  renderNewPage(className, key = "") {
    return React2.createElement(
      React2.Fragment,
      { key },
      React2.createElement("div", { className, "data-sv-drop-target-survey-element": "newGhostPage" }, !!this.model.newPage ? this.renderPage(this.model.newPage, true) : null)
    );
  }
  ...
  renderElement() {
    ...
    return React2.createElement(
      React2.Fragment,
      null,
      React2.createElement("div", { className: "svc-flex-column" }, this.model.isToolboxVisible ? ReactElementFactory.Instance.createElement("svc-toolbox", { model: this.creator }) : null),
      React2.createElement(
        "div",
        ...
        React2.createElement(
          Scroll,
          null,
          React2.createElement("div", { className: "svc-tab-designer_content" }, this.model.showPlaceholder ? this.renderPlaceHolder() : this.renderTabContent())
        )
      )
    );
  }
  renderHeader(condition) {
    ...
    return React2.createElement(
      ...
      React2.createElement(
        ...
        React2.createElement(SurveyHeader, { survey })
      )
    );
  }
  renderPlaceHolder() {
  ...
  renderPlaceHolderContent() {
    return React2.createElement(SurfacePlaceholder, { name: "designer", placeholderTitleText: this.model.placeholderTitleText, placeholderDescriptionText: this.model.placeholderDescriptionText });
  }
  renderTabContent() {
    const survey = this.creator.survey;
  ...
  renderTabTools() {
    if (!this.model.showSurfaceTools)
      return null;
    const pageNavigator = this.creator.showPageNavigator ? React2.createElement(
      "div",
      { className: "svc-tab-designer__page-navigator" },
      React2.createElement(SurveyPageNavigator, { pagesController: this.model.pagesController, pageEditMode: this.model.creator.pageEditMode })
    ) : null;
    const surfaceToolbar = this.model.showSurfaceToolbar ? React2.createElement(SurveyActionBar, { model: this.model.surfaceToolbar, handleClick: false }) : null;
    return React2.createElement(
      "div",
...
ReactElementFactory.Instance.registerElement("svc-tab-designer", (props) => {
  return React2.createElement(TabDesignerComponent, props);
});
var TabJsonEditorErrorsComponent = class extends SurveyElementBase {
  ...
  renderElement() {
    return React2.createElement(
      ...
      React2.createElement(List, { model: this.model.errorList })
    );
  }
};
var TabJsonEditorTextareaComponent = class extends SurveyElementBase {
  ...
  renderElement() {
    ...
    const errors = React2.createElement(TabJsonEditorErrorsComponent, { data: this.model });
    return React2.createElement(
      "div",
      ...
      React2.createElement(
        ...
        React2.createElement("textarea", { ref: (input) => setControl(input), className: "svc-json-editor-tab__content-area", value: this.model.text, onChange: (e) => this.model.text = e.target.value, onKeyDown: (e) => this.model.checkKey(e, e), disabled: this.model.readOnly, "aria-label": this.model.ariaLabel }),
        errors
      )
    );
  }
...
ReactElementFactory.Instance.registerElement("svc-tab-json-editor-textarea", (props) => {
  return React2.createElement(TabJsonEditorTextareaComponent, props);
});
var TabJsonEditorAceComponent = class extends SurveyElementBase {
  constructor(props) {
    super(props);
    this.aceEditorrRef = React2.createRef();
  }
  getStateElement() {
    return this.model;
  }
  ...
  renderElement() {
    ...
    return React2.createElement(
      ...
      React2.createElement(
        "div",
        { className: "svc-json-editor-tab__content" },
        React2.createElement("div", { className: "svc-json-editor-tab__ace-editor", ref: this.aceEditorrRef }),
        errors
      )
    );
  }
...
ReactElementFactory.Instance.registerElement("svc-tab-json-editor-ace", (props) => {
  return React2.createElement(TabJsonEditorAceComponent, props);
});
var TabLogicAddButtonComponent = class extends SurveyElementBase {
  ...
  renderElement() {
    ...
    return attachKey2click(React2.createElement(
      ...
      React2.createElement("span", { className: "svc-btn__text" }, this.model.title)
    ));
  }
};
ReactElementFactory.Instance.registerElement("svc-tab-logic-add-button", (props) => {
  return React2.createElement(TabLogicAddButtonComponent, props);
});
var TabLogicComponent = class extends SurveyElementBase {
  ...
  renderElement() {
    ...
    return React2.createElement("div", { className: rootClass }, content);
  }
  renderViewContent() {
    ...
    const addLogic = !this.model.readOnly ? React2.createElement(TabLogicAddButtonComponent, { button: this.model.addNewButton }) : void 0;
    return React2.createElement(
      import_react.Fragment,
      null,
      React2.createElement("div", { className: logicTabClassName }, this.model.hasItems ? React2.createElement(
        React2.Fragment,
        null,
        React2.createElement(Survey, { model: this.model.itemsSurvey }),
        addLogic
      ) : React2.createElement(
        "div",
        { className: "svc-logic-tab__content-empty" },
        React2.createElement(SurfacePlaceholder, { name: "logic", placeholderTitleText: this.model.placeholderTitleText, placeholderDescriptionText: this.model.placeholderDescriptionText }),
        addLogic
      ))
    );
  }
...
ReactElementFactory.Instance.registerElement("svc-tab-logic", (props) => {
  return React2.createElement(TabLogicComponent, props);
});
var SurveySimulator = class extends SurveyElementBase {
  ...
  renderElement() {
    ...
    if (!this.model.survey) {
      return React2.createElement("div", { className: mainSimulatorClass });
    }
        ...
        React2.createElement(
          ...
          React2.createElement(
            ...
            React2.createElement(
              ...
              React2.createElement(Survey, { model: this.model.survey })
            )
          )
        )
      );
...
ReactElementFactory.Instance.registerElement("svc-complete-page", (props) => {
  return React2.createElement(TabPreviewTestSurveyAgainComponent, props);
});
var TabPreviewSurveyComponent = class extends SurveyElementBase {
  ...
  renderPlaceholder() {
    return React2.createElement(SurfacePlaceholder, { name: "preview", placeholderTitleText: this.model.placeholderTitleText, placeholderDescriptionText: this.model.placeholderDescriptionText });
  }
  renderSimulator() {
    return React2.createElement(
      "div",
      { className: "svc-plugin-tab__content" },
      React2.createElement(SurveySimulator, { model: this.model.simulator }),
      this.model.showResults ? React2.createElement(SurveyResults, { survey: this.model.simulator.survey }) : null
    );
  }
  renderElement() {
  ...
  getBottomToolbar() {
    if (this.model.isPageToolbarVisible) {
      return React2.createElement(
        ...
        React2.createElement(SurveyActionBar, { model: this.model.pages })
      );
    } else {
      return null;
    }
...
ReactElementFactory.Instance.registerElement("svc-tab-preview", (props) => {
  return React2.createElement(TabPreviewSurveyComponent, props);
});
var PropertyGridPlaceholderComponent = class extends React2.Component {
  render() {
    return React2.createElement(
      "div",
      ...
      React2.createElement(
        ...
        React2.createElement("span", { className: "svc-property-grid-placeholder__title" }, editorLocalization.getString("ed.propertyGridPlaceholderTitle")),
        React2.createElement("span", { className: "svc-property-grid-placeholder__description" }, editorLocalization.getString("ed.propertyGridPlaceholderDescription"))
      ),
      React2.createElement(
        "div",
        { className: "svc-property-grid-placeholder__content" },
        React2.createElement("div", { className: "svc-property-grid-placeholder__gap" }),
        React2.createElement("div", { className: "svc-property-grid-placeholder__image" })
      )
    );
  }
};
ReactElementFactory.Instance.registerElement("svc-property-grid-placeholder", (props) => {
  return React2.createElement(PropertyGridPlaceholderComponent, props);
});
var TabThemeSurveyComponent = class extends SurveyElementBase {
  ...
  renderPlaceholder() {
    return React2.createElement(SurfacePlaceholder, { name: "theme", placeholderTitleText: this.model.placeholderTitleText, placeholderDescriptionText: this.model.placeholderDescriptionText });
  }
  renderSimulator() {
    return React2.createElement(
      "div",
...
ReactElementFactory.Instance.registerElement("svc-tab-theme", (props) => {
  return React2.createElement(TabThemeSurveyComponent, props);
});
var TabTranslationComponent = class extends SurveyElementBase {
  ...
  renderElement() {
    if (!this.model)
      return null;
    return React2.createElement("div", { className: "svc-creator-tab__content svc-translation-tab" + (this.model.isEmpty ? " svc-translation-tab--empty" : "") }, this.renderElementContent());
  }
  renderElementContent() {
    if (this.model.isEmpty) {
      return React2.createElement(SurfacePlaceholder, { name: "translation", placeholderTitleText: this.model.placeholderTitleText, placeholderDescriptionText: this.model.placeholderDescriptionText });
    } else {
      return React2.createElement(
        "div",
        ...
        React2.createElement(
          ...
          React2.createElement(
            ...
            React2.createElement(Survey, { model: this.model.stringsHeaderSurvey })
          ),
          React2.createElement(
            "div",
            { className: "svc-flex-row svc-plugin-tab__content st-strings" },
            React2.createElement(Survey, { model: this.model.stringsSurvey })
          )
        )
      );
    }
...
ReactElementFactory.Instance.registerElement("svc-tab-translation", (props) => {
  return React2.createElement(TabTranslationComponent, props);
});
var ObjectSelectorComponent = class extends SurveyElementBase {
  ...
  renderElement() {
    if (!this.model.isVisible)
      return null;
    return React2.createElement(List, { model: this.model.list });
  }
};
ReactElementFactory.Instance.registerElement("svc-object-selector", (props) => {
  return React2.createElement(ObjectSelectorComponent, props);
});
var PropertyGridComponent = class extends SurveyElementBase {
  ...
  renderElement() {
    return React2.createElement(
      ...
      React2.createElement(SearchComponent, { model: this.model.searchManager }),
      React2.createElement(Survey, { model: this.model.survey })
    );
  }
};
ReactElementFactory.Instance.registerElement("svc-property-grid", (props) => {
  return React2.createElement(PropertyGridComponent, props);
});
var SwitcherComponent = class extends SurveyElementBase {
  ...
  renderElement() {
    ...
    const title = this.item.hasTitle ? React2.createElement("span", { className: "svc-switcher__title" }, this.item.title) : null;
    const button = attachKey2click(React2.createElement(
      "button",
      ...
      React2.createElement(
        ...
        React2.createElement("div", { className: "svc-switcher__icon-thumb" })
      ),
      title
...
ReactElementFactory.Instance.registerElement("svc-switcher", (props) => {
  return React2.createElement(SwitcherComponent, props);
});
var ItemTemplateComponent$1 = class ItemTemplateComponent extends SurveyElementBase {
  render() {
    ...
    return React2.createElement(
      React2.Fragment,
      null,
      React2.createElement(SvgIcon, { iconName: item.iconName, size: item.iconSize, className: "svc-json-error__icon" }),
      React2.createElement(
        "div",
        ...
        React2.createElement(
          ...
          React2.createElement("span", { key: 2 }, this.renderLocString(item.locTitle, void 0, "locString"))
        ),
  ...
  renderFixButton() {
    ...
    return attachKey2click(React2.createElement(
      ...
      React2.createElement(SvgIcon, { iconName: item.data.fixButtonIcon, size: "auto" })
    ));
  }
};
ReactElementFactory.Instance.registerElement("json-error-item", (props) => {
  return React2.createElement(ItemTemplateComponent$1, props);
});
  ...
  renderButtons() {
    return React2.createElement(
      ...
      React2.createElement(
        ...
        React2.createElement(SvgIcon, { iconName: this.question.cssClasses.decreaseButtonIcon, size: "auto" })
      ),
      React2.createElement(
        "button",
        ...
        React2.createElement(SvgIcon, { iconName: this.question.cssClasses.increaseButtonIcon, size: "auto" })
      )
    );
  }
};
ReactQuestionFactory.Instance.registerQuestion("spinedit", (props) => {
  return React2.createElement(SurveyQuestionSpinEditor, props);
});
var ItemTemplateComponent2 = class extends SurveyElementBase {
  render() {
    ...
    return React2.createElement(
      React2.Fragment,
      null,
      React2.createElement("span", { className: "spg-color-editor__color-swatch", style: { backgroundColor: item.value } }),
      React2.createElement("span", { key: 2 }, this.renderLocString(item.locTitle, void 0, "locString"))
    );
  }
};
ReactElementFactory.Instance.registerElement("color-item", (props) => {
  return React2.createElement(ItemTemplateComponent2, props);
});
var SurveyQuestionColor = class extends SurveyQuestionText {
  ...
  renderColorSwatch() {
    return React2.createElement(
      ...
      React2.createElement(SvgIcon, { iconName: this.question.cssClasses.swatchIcon, size: "auto" }),
      React2.createElement("input", { type: "color", disabled: this.isDisplayMode, value: this.question.renderedColorValue, className: this.question.cssClasses.colorInput, onChange: (event) => this.question.onColorInputChange(event.nativeEvent), tabIndex: -1, "aria-required": this.question.a11y_input_ariaRequired, "aria-labelledby": this.question.a11y_input_ariaLabelledBy, "aria-label": this.question.a11y_input_ariaLabel, "aria-invalid": this.question.a11y_input_ariaInvalid, "aria-describedby": this.question.a11y_input_ariaDescribedBy })
    );
  }
  renderDropdownAction() {
    return React2.createElement(
      React2.Fragment,
      null,
      React2.createElement("div", { "aria-hidden": "true", className: this.question.cssClasses.choicesButtonWrapper }, ReactElementFactory.Instance.createElement("sv-action-bar-item", { item: this.question.dropdownAction })),
      this.renderPopup()
    );
  }
  renderPopup() {
    return React2.createElement(Popup, { model: this.question.dropdownAction.popupModel });
  }
};
ReactQuestionFactory.Instance.registerQuestion("color", (props) => {
  return React2.createElement(SurveyQuestionColor, props);
});
var SurveyQuestionFileEditor = class extends SurveyQuestionText {
  ...
  renderClearButton() {
    return attachKey2click(React2.createElement(
      ...
      React2.createElement(SvgIcon, { iconName: this.questionFile.cssClasses.clearButtonIcon, size: "auto" })
    ));
  }
  renderChooseButton() {
    return attachKey2click(React2.createElement(
      ...
      React2.createElement(SvgIcon, { iconName: this.questionFile.cssClasses.chooseButtonIcon, size: "auto", title: this.questionFile.chooseButtonCaption })
    ));
  }
  renderElement() {
    return React2.createElement(
...
ReactQuestionFactory.Instance.registerQuestion("fileedit", (props) => {
  return React2.createElement(SurveyQuestionFileEditor, props);
});
var SurveyQuestionTextWithReset = class extends SurveyQuestionElementBase {
  ...
  renderResetButton() {
    return React2.createElement(
      ...
      React2.createElement(SvgIcon, { iconName: this.question.cssClasses.resetButtonIcon, size: "auto" })
    );
  }
};
ReactQuestionFactory.Instance.registerQuestion("textwithreset", (props) => {
  return React2.createElement(SurveyQuestionTextWithReset, props);
});
...
var SurveyQuestionBooleanSwitch = class extends SurveyQuestionElementBase {
  renderElement() {
    const button = attachKey2click(React2.createElement(
      "div",
      { className: "spg-boolean-switch__button" + (this.questionBase.value ? " spg-boolean-switch__button--checked" : ""), tabIndex: 0, role: "checkbox", "aria-checked": this.questionBase.booleanValue || false, "aria-required": this.questionBase.a11y_input_ariaRequired, "aria-label": this.questionBase.a11y_input_ariaLabel, "aria-labelledby": this.questionBase.a11y_input_ariaLabelledBy, "aria-invalid": this.questionBase.a11y_input_ariaInvalid, "aria-errormessage": this.questionBase.a11y_input_ariaErrormessage },
      React2.createElement(
        "div",
        { className: "spg-boolean-switch__thumb" },
        React2.createElement("div", { className: "spg-boolean-switch__thumb-circle spg-boolean-switch__thumb--left" })
      ),
      React2.createElement(
        "div",
        { className: "spg-boolean-switch__thumb" },
        React2.createElement("div", { className: "spg-boolean-switch__thumb-circle spg-boolean-switch__thumb--right" })
      )
    ), this.questionBase, { processEsc: false });
    return React2.createElement(
      "div",
      { className: "spg-boolean-switch", onClick: () => this.questionBase.value = !this.questionBase.value },
      button,
      React2.createElement(
        "div",
        { className: "spg-boolean-switch__caption" },
        React2.createElement("div", { className: "spg-boolean-switch__title", id: this.questionBase.labelRenderedAriaID }, SurveyElementBase.renderLocString(this.questionBase.locTitle))
      )
    );
  }
};
ReactQuestionFactory.Instance.registerQuestion("sv-boolean-switch", (props) => {
  return React2.createElement(SurveyQuestionBooleanSwitch, props);
});
...
export {
  ...
  QuestionErrorComponent2 as QuestionErrorComponent,
  ...
  SurveyLocStringEditor2 as SurveyLocStringEditor,
  SurveyLogic,
  SurveyLogicOpertor,
  SurveyLogicUI,
  SurveyNavigation,
...
survey-creator-react/fesm/survey-creator-react.mjs:
  (*!
